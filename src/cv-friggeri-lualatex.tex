...
{\emph{Tightly Integrated Neural Network Accelerator Architectures} \\
  ...
  \item Multi-transaction, arbitrary-topology neural network accelerator for a RISC-V microprocessor modeled in \CPP and implemented in SystemVerilog and Chisel
...
{\emph{Graduate Technical Intern} \\
  Tested and validated memory controllers in Verilog/SystemVerilog RTL for an Intel server microprocessor
}
